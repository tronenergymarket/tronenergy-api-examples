...
const INSTANT = true; //true for executing the order instantly before going to the filling round. It speeds up minutes order to get completed in seconds.
const LISTED = true; //false to not list the order publicly. This will limit fillers to only the pools.
